    ...
    */
    ...
    'connections' => [
        ...
        'user_login' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_USER_LOGIN', '127.0.0.1'),
            'port' => env('DB_PORT_USER_LOGIN', '13306'),
            'database' => env('DB_DATABASE_USER_LOGIN', 'forge'),
            'username' => env('DB_USERNAME_USER_LOGIN', 'forge'),
            'password' => env('DB_PASSWORD_USER_LOGIN', ''),
        ...
        'dbo' => [
            'driver' => 'sqlsrv',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_DBO', 'localhost'),
            'port' => env('DB_PORT_DBO', '1433'),
            'database' => env('DB_DATABASE_DBO', 'forge'),
            'username' => env('DB_USERNAME_DBO', 'forge'),
            'password' => env('DB_PASSWORD_DBO', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
        ],
